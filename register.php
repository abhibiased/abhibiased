...
$query="insert into user(name,email,class,address,phone) values('$name','$email','$class','$address','$phone')";
...
{
echo '<script type="text/javascript">alert("Successfully Registered you would be contacted shortly...!!");</script>';
}
